...
(NB: Shen et al.'s Table S1 file was [updated](img/TableS1_v2_metadata.png) in September 2021. The original version of Table S1 had issues: the patients' outcomes were interverted for all but one patients).  
